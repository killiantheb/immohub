...
const propertyPin = L.divIcon({
  ...
  html: `<svg width="36" height="45" viewBox="0 0 36 45" xmlns="http://www.w3.org/2000/svg">
    ...
    <path filter="url(#ps)" d="M18 1C10.8 1 5 6.8 5 14c0 10.3 13 30 13 30S31 24.3 31 14C31 6.8 25.2 1 18 1z" fill="#0F2E4C" stroke="white" stroke-width="1.5"/>
          ...
          >
            <Popup>
              <div style={{ fontSize: 12 }}>
                ...
                {!readOnly && <p style={{ color: "#0F2E4C", marginTop: 4 }}>Glissez pour ajuster</p>}
              </div>
            </Popup>
          </Marker>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
            ...
            {POI_RADIUS_OPTIONS.map(o => (
              <button key={o.value} onClick={() => setPoiRadius(o.value)} style={{ padding: "4px 12px", borderRadius: 20, fontSize: 11, fontWeight: 600, cursor: "pointer", border: `1px solid ${poiRadius === o.value ? "#0F2E4C" : "#E8E4DC"}`, background: poiRadius === o.value ? "#D6E0ED" : "#fff", color: poiRadius === o.value ? "#0F2E4C" : "#7A7469" }}>
                {o.label}
              </button>
            ))}
          </div>
