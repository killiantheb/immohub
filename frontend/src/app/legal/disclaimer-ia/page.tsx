    ...
    <>
      ...
      <ul style={{ paddingLeft: "1.5rem", margin: "0.5rem 0" }}>
        {[
          ...
          <li key={item} style={{ fontSize: 14, lineHeight: 1.75, color: "#4A4440", marginBottom: "0.2rem" }}>{item}</li>
        ))}
      </ul>
      ...
      <div style={{ display: "grid", gap: "0.75rem", margin: "0.75rem 0" }}>
        {[
          ...
          <div key={item.title} style={{ padding: "0.875rem 1rem", background: "#fff", borderRadius: 10, border: "1px solid #E8E4DC" }}>
            <p style={{ fontWeight: 700, fontSize: 13, color: "#3D3830", marginBottom: 4 }}>{item.title}</p>
            <p style={{ fontSize: 13, color: "#4A4440", lineHeight: 1.65 }}>{item.text}</p>
          </div>
        ))}
      </div>
      ...
      <ul style={{ paddingLeft: "1.5rem", margin: "0.5rem 0" }}>
        <li style={{ fontSize: 14, lineHeight: 1.75, color: "#4A4440", marginBottom: "0.25rem" }}>La vérification de la conformité du document avec le droit applicable (droit suisse du bail, loi cantonale, etc.)</li>
        <li style={{ fontSize: 14, lineHeight: 1.75, color: "#4A4440", marginBottom: "0.25rem" }}>L'exactitude des informations saisies (noms, adresses, montants, dates)</li>
        <li style={{ fontSize: 14, lineHeight: 1.75, color: "#4A4440", marginBottom: "0.25rem" }}>La décision d'utiliser ou non le document généré</li>
        <li style={{ fontSize: 14, lineHeight: 1.75, color: "#4A4440", marginBottom: "0.25rem" }}>Les conséquences juridiques et financières découlant de l'utilisation du document</li>
        <li style={{ fontSize: 14, lineHeight: 1.75, color: "#4A4440", marginBottom: "0.25rem" }}>La signature et la notification des parties concernées</li>
      </ul>
      ...
      <ul style={{ paddingLeft: "1.5rem", margin: "0.5rem 0" }}>
        <li style={{ fontSize: 14, lineHeight: 1.75, color: "#4A4440", marginBottom: "0.25rem" }}>Toute erreur, omission ou inexactitude dans les documents générés</li>
        <li style={{ fontSize: 14, lineHeight: 1.75, color: "#4A4440", marginBottom: "0.25rem" }}>Tout litige découlant de l'utilisation d'un document non validé par un professionnel</li>
        <li style={{ fontSize: 14, lineHeight: 1.75, color: "#4A4440", marginBottom: "0.25rem" }}>Toute non-conformité avec des dispositions légales spécifiques non connues du modèle</li>
        <li style={{ fontSize: 14, lineHeight: 1.75, color: "#4A4440", marginBottom: "0.25rem" }}>Tout dommage résultant d'une décision prise sur la base d'une estimation IA</li>
      </ul>
      ...
      <div style={{ display: "grid", gap: "0.5rem", margin: "0.75rem 0" }}>
        {[
          ...
          <div key={r.icon} style={{ display: "flex", gap: "0.75rem", alignItems: "flex-start", padding: "0.75rem 1rem", background: "#FAFAF8", borderRadius: 10, border: "1px solid #E8E4DC" }}>
            <span style={{ fontSize: 20, flexShrink: 0 }}>{r.icon}</span>
            <p style={{ fontSize: 13, color: "#4A4440", lineHeight: 1.65, margin: 0 }}>{r.text}</p>
          </div>
        ))}
      </div>
