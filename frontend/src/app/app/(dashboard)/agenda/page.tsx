...
import { CalendarDays, CalendarPlus, Link2, RefreshCw, Clock, MapPin } from "lucide-react";
              ...
              <div key={dateKey}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 11, color: "var(--althy-text-3)" }}>{dayEvents.length} événement{dayEvents.length > 1 ? "s" : ""}</div>
                  </div>
                </div>
