    ...
    <div>
      ...
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex gap-2">
          <Link href="/openers/map" className="btn-secondary flex items-center gap-2 text-sm">
            <Map className="h-4 w-4" />
            Carte
          </Link>
          <Link href="/openers/new" className="btn-primary flex items-center gap-2 text-sm">
      ...
      {isLoading ? (
        ...
        <div className="card flex flex-col items-center py-16 text-center">
          ...
          <Link href="/openers/new" className="btn-primary mt-4 text-sm">
            Créer une mission
          </Link>
        </div>
      ) : (
